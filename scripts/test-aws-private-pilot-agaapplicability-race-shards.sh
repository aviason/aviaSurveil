...
# Keep race verification isolated from the repository and from unrelated Go
# work. The heavy immutable-graph tests are intentionally separate shards;
# the package-wide race command can exceed a ten-minute wall-clock budget.
export GOMODCACHE="/private/tmp/avia-task8-modcache"
export GOPATH="/private/tmp/avia-task8-gopath"
export GOCACHE="/private/tmp/avia-task8-gocache"
export GOTMPDIR="/private/tmp/avia-task8-gotmp"
mkdir -p "${GOTMPDIR}"
