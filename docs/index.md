...
| `demo-evidence/PLAN5_IDENTITY_DATA_FOUNDATION_2026-07-28.md` | Plan 5 Tasks 1–2 contract, normal/canonical-test artifact split, append-only membership, least-privilege Keycloak service client, provider-backed directory, RED evidence, fresh local verification, and explicit Tasks 3–9 boundaries. |
