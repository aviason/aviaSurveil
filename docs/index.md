...
| `demo-evidence/PLAN5_IDENTITY_DATA_FOUNDATION_2026-07-28.md` | Plan 5 Tasks 1–3 contract, normal/canonical-test artifact split, append-only membership, least-privilege Keycloak service client, provider-backed directory, revision-guarded invitation/recovery lifecycle, RED evidence, fresh local verification, and explicit Tasks 4–9 boundaries. |
