...
| `security/auth-replacement/README.md` | Current first-party Go OIDC implementation, repository-local retirement plan, and Task 11 evidence. |
...
| `demo-evidence/stakeholder/PLANS2_4_STAKEHOLDER_DISPOSITION_2026-07-28.md` | Provenance-only replacement for the deleted combined Plans 2–4 disposition; it preserves exact Git identity without restoring historical content. |
...
Go/PostgreSQL HTTP path, first-party local OIDC exchange, private MinIO upload,
