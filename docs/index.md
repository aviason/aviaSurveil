...
| `demo-evidence/PLAN5_IDENTITY_DATA_FOUNDATION_2026-07-28.md` | Plan 5 Tasks 1–5 contract, normal/canonical-test artifact split, append-only membership, least-privilege Keycloak service client, provider-backed directory, revision-guarded invitation/recovery lifecycle, exact desired/provider/token/session authority, complete reason-confirmed Users and Roles Admin experience, live OIDC/MFA/revocation evidence, strict RED results, fresh local verification, and explicit Tasks 6–9 boundaries. |
