...
const ROUTE_SEEDS = [
  ...
  { auditId: "ui-audit-007", id: "audit-detail", path: "/inspector/audits/:auditId", requiredRole: "inspector", placement: "contextual", parentId: "inspector-home", label: "Audit Detail", iconKey: "assignments", dataBoundary: "backend" },
  { auditId: "ui-audit-008", id: "checklist-runner", path: "/inspector/audits/:auditId/checklist", requiredRole: "inspector", placement: "contextual", parentId: "audit-detail", label: "Checklist Runner", iconKey: "assignments", dataBoundary: "backend+field" },
  { auditId: "ui-audit-009", id: "finding-detail", path: "/inspector/findings/:findingId", requiredRole: "inspector", placement: "contextual", parentId: "inspector-findings", label: "Finding Detail", iconKey: "assignments", dataBoundary: "backend" },
  { auditId: "ui-audit-010", id: "closure-report-preview", path: "/inspector/closure-reports/:closureReportId", requiredRole: "inspector", placement: "contextual", parentId: "finding-detail", label: "Closure Report Preview", iconKey: "reports", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-015", id: "lead-preliminary-report-workflow", path: "/lead-inspector/preliminary-reports/:reportId", requiredRole: "leadInspector", placement: "contextual", parentId: "lead-preliminary-reports", label: "Preliminary Report Workflow", iconKey: "reports", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-017", id: "lead-final-report-readiness", path: "/lead-inspector/final-reports/:reportId/readiness", requiredRole: "leadInspector", placement: "contextual", parentId: "lead-final-reports", label: "Final Report Readiness", iconKey: "reports", dataBoundary: "backend" },
  { auditId: "ui-audit-018", id: "lead-prepare-final-report", path: "/lead-inspector/final-reports/:reportId/prepare", requiredRole: "leadInspector", placement: "contextual", parentId: "lead-final-reports", label: "Prepare Final Report", iconKey: "reports", dataBoundary: "backend" },
  { auditId: "ui-audit-019", id: "lead-final-report-document", path: "/lead-inspector/final-reports/:reportId/document", requiredRole: "leadInspector", placement: "contextual", parentId: "lead-final-reports", label: "Final Report Document", iconKey: "reports", dataBoundary: "backend" },
  { auditId: "ui-audit-020", id: "lead-audit-assignment", path: "/lead-inspector/audits/:auditId/assignment", requiredRole: "leadInspector", placement: "contextual", parentId: "lead-home", label: "Audit Assignment", iconKey: "assignments", dataBoundary: "backend" },
  { auditId: "ui-audit-021", id: "lead-checklist-question-assignment", path: "/lead-inspector/audits/:auditId/checklist-questions", requiredRole: "leadInspector", placement: "contextual", parentId: "lead-home", label: "Assign Checklist Questions", iconKey: "templates", dataBoundary: "backend" },
  { auditId: "ui-audit-022", id: "cap-review", path: "/lead-inspector/cap-review/:findingId", requiredRole: "leadInspector", placement: "contextual", parentId: "lead-home", label: "CAP Review", iconKey: "leadReview", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-030", id: "report-preview", path: "/department-manager/reports/:reportVersionId", requiredRole: "manager", placement: "primary", parentId: null, label: "Report Preview", iconKey: "reports", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-037", id: "organization-risk-profile", path: "/department-manager/organizations/:organizationId/risk-profile", requiredRole: "manager", placement: "contextual", parentId: "organization-registry", label: "Organization Risk Profile", iconKey: "organizations", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-042", id: "organization-detail", path: "/department-manager/organizations/:organizationId", requiredRole: "manager", placement: "contextual", parentId: "organization-registry", label: "Organization Detail", iconKey: "organizations", dataBoundary: "backend" },
  { auditId: "ui-audit-044", id: "evidence-review", path: "/department-manager/evidence/:findingId", requiredRole: "manager", additionalRoles: ["leadInspector", "inspector"], placement: "contextual", parentId: "manager-findings-review", label: "Inspection Evidence", iconKey: "leadReview", dataBoundary: "backend" },
  { auditId: "ui-audit-045", id: "manager-preliminary-report-review", path: "/department-manager/preliminary-reports/:reportId", requiredRole: "manager", placement: "contextual", parentId: "report-preview", label: "Preliminary Report Review", iconKey: "reports", dataBoundary: "backend" },
  { auditId: "ui-audit-046", id: "manager-cap-closure-review", path: "/department-manager/findings/:findingId/closure-review", requiredRole: "manager", placement: "contextual", parentId: "manager-cap-monitoring", label: "Department CAP Closure Review", iconKey: "leadReview", dataBoundary: "backend" },
  { auditId: "ui-audit-047", id: "new-audit-wizard-1", path: "/department-manager/new-audit/step-1", requiredRole: "manager", placement: "contextual", parentId: "audit-plan", label: "New Audit · Scope", iconKey: "planning", dataBoundary: "backend" },
  { auditId: "ui-audit-048", id: "new-audit-wizard-2", path: "/department-manager/new-audit/step-2", requiredRole: "manager", placement: "contextual", parentId: "audit-plan", label: "New Audit · Purpose", iconKey: "planning", dataBoundary: "backend" },
  { auditId: "ui-audit-049", id: "new-audit-wizard-3", path: "/department-manager/new-audit/step-3", requiredRole: "manager", placement: "contextual", parentId: "audit-plan", label: "New Audit · Schedule", iconKey: "planning", dataBoundary: "backend" },
  { auditId: "ui-audit-050", id: "new-audit-wizard-4", path: "/department-manager/new-audit/step-4", requiredRole: "manager", placement: "contextual", parentId: "audit-plan", label: "New Audit · Resources & budget", iconKey: "planning", dataBoundary: "backend" },
  { auditId: "ui-audit-051", id: "new-audit-wizard-5", path: "/department-manager/new-audit/step-5", requiredRole: "manager", placement: "contextual", parentId: "audit-plan", label: "New Audit · Review", iconKey: "planning", dataBoundary: "backend" },
  { auditId: "ui-audit-087", id: "post-release-checklist-selection", path: "/department-manager/planning/:planningItemId/setup/checklist", requiredRole: "manager", placement: "contextual", parentId: "audit-plan", label: "Post-release Checklist Preparation", iconKey: "templates", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-063", id: "executive-report-preview", path: "/executive-director/reports/:reportVersionId", requiredRole: "executiveDirector", placement: "contextual", parentId: "executive-final-reports", label: "Executive Report Preview", iconKey: "reports", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-070", id: "auditee-report-preview", path: "/auditee/reports/:reportVersionId", requiredRole: "auditee", placement: "contextual", parentId: "auditee-final-reports", label: "Report Preview", iconKey: "reports", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-079", id: "admin-version-history", path: "/admin/templates/:templateId/history", requiredRole: "admin", placement: "primary", parentId: null, label: "Version History", iconKey: "templates", dataBoundary: "backend" },
  ...
  { auditId: "ui-audit-085", id: "admin-organization-detail", path: "/admin/organization-master-data/:organizationId", requiredRole: "admin", placement: "contextual", parentId: "admin-organization-master-data", label: "Organization Detail", iconKey: "organizations", dataBoundary: "backend" },
