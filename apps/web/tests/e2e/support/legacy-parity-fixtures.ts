...
const CORE_VISUAL_SURFACES: readonly VisualSurfaceFixture[] = [
  {
    ...
    expectedPrimaryActionText: "Explore the local workspace",
  ...
  },
  {
    ...
    expectedNextActionText: "Lead decision required",
    expectedStatusText: "PENDING LEAD REVIEW",
    expectedDueDateText: null,
    expectedPrimaryActionText: "Lead decision required",
  ...
  },
  {
    ...
    expectedOwnerText: "Authorized organization",
    expectedNextActionText: "CAP required",
    expectedStatusText: "CAP",
    expectedDueDateText: "Due Date",
    expectedPrimaryActionText: "Select",
  ...
  },
  {
    ...
    stableSelector: "main.content",
    expectedHeading: "2026 Cabin Inspection - Fly Namibia",
  ...
  },
  {
    ...
    stableSelector: "main.content",
    expectedHeading: "Checklist Runner",
    expectedSemanticMarker: "Organization unavailable",
    expectedRoleText: "CAA Inspector",
    expectedOwnerText: "Amina Inspector",
  ...
  },
  {
    ...
    legacy: { role: "inspector", view: "finding", params: { findingId: "CAB-2026-001" } },
    stableSelector: "main.content",
  ...
  },
  {
    ...
    expectedRoleText: "Department Manager",
    expectedOwnerText: "ORG-FLY-NAMIBIA",
    expectedNextActionText: "Review",
...
const LEGACY_ROUTE_FIXTURES: Partial<Record<ReactSurfaceId, LegacyRouteFixture>> = {
  ...
  "organization-detail": { role: "manager", view: "org-detail", params: { orgId: "ORG-FLY-NAMIBIA" } },
...
const REVIEWED_SOURCE_ASSERTIONS: Partial<Record<ReactSurfaceId, ReviewedLegacyAssertion>> = {
  ...
  "closure-report-preview": { expectedHeading: "Report Preview", expectedSemanticMarker: "Report version was not found." },
  "inspector-assistant": { expectedHeading: "AI Inspector Assistant Panel", expectedSemanticMarker: "AI-generated draft" },
  ...
  "lead-preliminary-report-workflow": { expectedHeading: "Preliminary Report", expectedSemanticMarker: "Report version was not found.", legacyState: { preliminaryWorkflow: true } },
  "lead-final-reports": { expectedHeading: "Final Reports", expectedSemanticMarker: "FR-2026-018" },
  "lead-final-report-readiness": { expectedHeading: "Final Report Readiness", expectedSemanticMarker: "Report version was not found." },
  "lead-prepare-final-report": { expectedHeading: "Final Report Preparation", expectedSemanticMarker: "Report version was not found." },
  ...
  "manager-audits": { expectedHeading: "Audit Work Queue", expectedSemanticMarker: "Fly Namibia · Audit 2026-001" },
  ...
  "manager-findings-review": { expectedHeading: "Findings Review", expectedSemanticMarker: "CAB-2026-001" },
  "manager-cap-monitoring": { expectedHeading: "CAP Monitoring", expectedSemanticMarker: "CAP" },
  "manager-checklist-management": { expectedHeading: "Checklist Management", expectedSemanticMarker: "Approved AGA catalog" },
  "manager-safety-intelligence": { expectedHeading: "Safety Intelligence Dashboard", expectedSemanticMarker: "Management attention" },
  "organization-risk-profile": { expectedHeading: "Organization Risk Profile", expectedSemanticMarker: "Organization unavailable" },
  "manager-ssp-nasp": { expectedHeading: "SSP/NASP Management Dashboard", expectedSemanticMarker: "State safety monitoring" },
  "manager-usoap-readiness": { expectedHeading: "USOAP Readiness Workspace", expectedSemanticMarker: "Configured readiness support" },
  ...
  "executive-report-preview": { expectedHeading: "Final Report Preview", expectedSemanticMarker: "Report version was not found." },
  ...
  "auditee-preliminary-reports": { expectedHeading: "Preliminary Reports", expectedSemanticMarker: "PR-2026-018-V1" },
  "auditee-final-reports": { expectedHeading: "Final Reports", expectedSemanticMarker: "RPT-CAB-2026-001-V1" },
  "auditee-report-preview": { expectedHeading: "Report Preview", expectedSemanticMarker: "Released report unavailable" },
  "auditee-messages": { expectedHeading: "Messages from the CAA", expectedSemanticMarker: "Inspection coordination update" },
  "auditee-documents": {
  ...
  "admin-checklist-builder": { expectedHeading: "Approved AGA Catalog", expectedSemanticMarker: "Approved AGA Catalog" },
  "admin-version-history": { expectedHeading: "Version History — Cabin Inspection", expectedSemanticMarker: "v1.1" },
  "admin-inspection-package-builder": { expectedHeading: "Approved AGA Catalog", expectedSemanticMarker: "Approved AGA Catalog" },
  ...
  "admin-organization-detail": { expectedHeading: "Organization Detail", expectedSemanticMarker: ":organizationId has no declared contextual Admin detail route." },
...
const REACT_SURFACE_SEMANTIC_OVERRIDES = {
  ...
  "manager-checklist-management": {
    expectedSemanticMarker: "Approved AGA catalog",
  },
  "lead-home": {
  ...
  "manager-cap-closure-review": {
    ...
    expectedSemanticMarker: "Finding :findingId was not found.",
  },
  "audit-plan": {
  ...
  "admin-version-history": {
    ...
    expectedSemanticMarker: "No version history is available for :templateId",
  },
